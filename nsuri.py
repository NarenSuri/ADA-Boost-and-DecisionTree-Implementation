...
import nsuriBagging as bagging
...
def load_data(datapath):
    print "Im not using this fucntion given by you"
    print "My both algorithms will handle the file and you just have to give the path where they are"
    print "if you want to see how i have implemented it : please look at \n fileprocessing.py and \n nsuriBagging.py and AdaBoosting.py"
    pass
...
def learn_bagged(tdepth, numbags, datapath):
    print  "nsuriBagging.py file" 
    bagging.BaggingHook(numbags,tdepth,datapath)
    pass;
...
def learn_boosted(tdepth, numtrees, datapath):
    print  "AdaBoosting.py file" 
    ada.startTheAdabootHook(numtrees,tdepth,datapath)
    pass;
